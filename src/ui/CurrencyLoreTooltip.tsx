...
export function CurrencyLoreTooltip({
  ...
  const borderColor = isAnchor ? DARK_HEX.breachGlow : SKILL_TREE_VISUAL.tooltipBorder;
  const accentColor = isAnchor ? DARK_HEX.breachGlow : SKILL_TREE_VISUAL.gold;
  const iconBorder = isAnchor ? DARK_HEX.breachGlow : SKILL_TREE_VISUAL.goldMuted;
